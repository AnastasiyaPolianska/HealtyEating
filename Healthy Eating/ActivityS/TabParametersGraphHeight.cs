...
{
    public class TabParametersGraphHeight : Fragment
    {
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            //Graph settings.
            Graph.SetBackgroundColor(Android.Graphics.Color.Rgb(250, 178, 102));
            ...
            if (Classes.User.CurrentUser != -1)
            {
                ...
                foreach (ParametresOfUser TempParametres in DatabaseUser.GetUser(User.CurrentUser).Parameters)
                    ListForData.Add(new ChartDataPoint(TempParametres.EntryDate.ToShortDateString(), TempParametres.Height));
                ...
                Seria.DataMarker.MarkerColor = Android.Graphics.Color.DarkGreen;
                Seria.Color = Android.Graphics.Color.DarkGreen;
