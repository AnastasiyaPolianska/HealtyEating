...
{
    class HelpclassListAdapter : BaseAdapter<TableRowParameters>
    {
        public List<TableRowParameters> ParametersRowList;
        Activity context;

        /*Constructor*/
        public HelpclassListAdapter(Activity context, List<TableRowParameters> items) : base() 
        {
        ...
        /*Functions*/
        public override TableRowParameters this[int position]
        {
            get
            {
        ...
        public override View GetView(int position, View convertView, ViewGroup parent)
        {
            ...
            if (view == null)
            {
                view = context.LayoutInflater.Inflate(Resource.Layout.helpform_ParametersRow, null);
            }
